...
description: Delegate code work to DeepSeek V4 (the deepseek_* MCP tools) when the task can be broken into mechanical chunks. Trigger when the user has a multi-step plan, when scanning unknown folders, or when getting a second opinion on risky code.
---
